...
| `111`     | **Válida** | **Todos os símbolos são `0` ou `1`.** |
...
3. $01 \in \Sigma$ — **Falso**, pois `01` é uma palavra, não um símbolo.
4. $01 \in \Sigma^*$ — **Verdadeiro.**
5. $2 \in \Sigma$ — **Falso**, pois `2` não pertence ao alfabeto.
6. $101 \in \Sigma^*$ — **Verdadeiro**, pois todos os símbolos pertencem ao alfabeto.
...
2. Explique o significado de $b^n$. **Significa `n` ocorrências do símbolo `b`.**
3. A palavra `bbbbbb` pertence à linguagem? **Sim, pois `bbbbbb = b^6` e `6 ≥ 1`.**
4. A palavra vazia ($\varepsilon$) pertence à linguagem? **Não, pois a condição é `n ≥ 1`.**
...
1. Qual delas possui uma palavra? **B, $L={\varepsilon}$.**
2. Qual delas não possui nenhuma palavra? **A, $L=\emptyset$.**
3. Qual é o comprimento da palavra $\varepsilon$? **0.**
...
3. O conjunto de produções. **$P={S\rightarrow0A,\ A\rightarrow1}$.**
4. O símbolo inicial. **$S$.**
5. Qual palavra pode ser gerada por essa gramática? **`01`, pois $S\Rightarrow0A\Rightarrow01$.**
...
1. Aplique a regra uma vez. **$S\Rightarrow0S$.**
2. Aplique a regra duas vezes. **$S\Rightarrow0S\Rightarrow00S$.**
3. Aplique a regra três vezes. **$S\Rightarrow0S\Rightarrow00S\Rightarrow000S$.**
4. Escreva a sequência completa de derivação. **$S\Rightarrow0S\Rightarrow00S\Rightarrow000S$.**
...
**Escreva todos os passos da derivação.** **$S\Rightarrow aS\Rightarrow aaS\Rightarrow aaaS\Rightarrow aaab$.**
...
1. `1` — **Sim:** $S\Rightarrow1$.
2. `01` — **Sim:** $S\Rightarrow0S\Rightarrow01$.
3. `001` — **Sim:** $S\Rightarrow0S\Rightarrow00S\Rightarrow001$.
4. `0001` — **Sim:** $S\Rightarrow0S\Rightarrow00S\Rightarrow000S\Rightarrow0001$.
5. `101` — **Não**, porque a regra $S\rightarrow1$ encerra a derivação.
6. `1001` — **Não**, porque depois de produzir `1` a derivação termina.
...
A palavra `b` pode ser gerada? **Sim:** $S\Rightarrow b$.

### 2.

A palavra `ab` pode ser gerada? **Sim:** $S\Rightarrow aS\Rightarrow ab$.

### 3.

A palavra `aab` pode ser gerada? **Sim:** $S\Rightarrow aS\Rightarrow aaS\Rightarrow aab$.

### 4.

A palavra `aaab` pode ser gerada? **Sim:** $S\Rightarrow aS\Rightarrow aaS\Rightarrow aaaS\Rightarrow aaab$.

### 5.

A palavra `aba` pode ser gerada? **Não**, porque a gramática termina quando usamos $S\rightarrow b$.

### 6.

Escreva a derivação completa de `aaaab`. **$S\Rightarrow aS\Rightarrow aaS\Rightarrow aaaS\Rightarrow aaaaS\Rightarrow aaaab$.**

### 7.

Descreva, com suas palavras, o padrão das palavras geradas por essa gramática. **São palavras formadas por zero ou mais `a`, seguidos de um único `b` no final.**
